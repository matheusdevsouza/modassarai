...
export default function AdminDashboard() {
      ...
      <div className="space-y-6">
        <div className="animate-pulse">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="h-32 bg-[#1f1f1f] border border-[#2a2a2a] rounded-xl"></div>
            ))}
          </div>
        </div>
      </div>
  ...
  if (error) {
    return (
      <div className="space-y-6">
        <div className="bg-[#1f1f1f] border border-red-500/30 rounded-xl p-6 text-center">
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <select
            ...
            className="bg-[#1f1f1f] border border-[#2a2a2a] rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-[var(--logo-gold,#D4A574)]"
          >
          ...
          <button
            onClick={refreshStats}
            className="p-2 text-gray-400 hover:text-white hover:bg-[var(--logo-gold,#D4A574)]/10 rounded-lg transition-all duration-300"
      ...
      >
        {statsCards.map((stat, index) => (
          <motion.div
            ...
            className="group relative bg-[#1f1f1f] border border-[#2a2a2a] rounded-xl p-4 hover:border-[var(--logo-gold,#D4A574)]/30 transition-all duration-300 hover:shadow-lg hover:shadow-[var(--logo-gold,#D4A574)]/5"
          >
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-lg bg-[var(--logo-gold,#D4A574)]/20 flex items-center justify-center group-hover:bg-[var(--logo-gold,#D4A574)]/30 transition-all duration-300 border border-[var(--logo-gold,#D4A574)]">
                <stat.icon className="text-[var(--logo-gold,#D4A574)] text-lg" />
              </div>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-[var(--logo-gold,#D4A574)] hover:text-[var(--logo-gold-light,#E6B896)] text-xs font-medium transition-colors duration-300">
            Ver todas
          </button>
        </div>
        <div className="space-y-3">
          {stats?.recentActivity?.orders?.map((order, index) => (
            <motion.div
              key={`order-${order.id}`}
              variants={itemVariants}
              className="flex items-center gap-3 p-3 bg-[#1f1f1f] rounded-lg border border-[#2a2a2a]"
            >
