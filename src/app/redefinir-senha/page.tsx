      ...
      <div className="w-full max-w-md bg-dark-900 border border-dark-800 rounded-xl p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <motion.button
            ...
            className="group relative w-full rounded-lg bg-[var(--logo-gold,#D4AF37)] disabled:bg-gray-600 disabled:opacity-60 disabled:cursor-not-allowed text-[#0D0D0D] py-2 font-semibold shadow-lg shadow-[var(--logo-gold,#D4AF37)]/20 overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
          >
            <motion.div
              initial={{ opacity: 0 }}
