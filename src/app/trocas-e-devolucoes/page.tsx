        ...
        <section className="space-y-8">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-sage-900">Política de Trocas</h2>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <FaUndo className="text-primary-600" size={24} />
              <h2 className="text-xl font-semibold text-sage-900">Como Solicitar uma Troca</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <h3 className="text-lg font-semibold text-primary-600 mb-2">1. Entre em Contato</h3>
                <p className="text-sage-800 text-sm">Entre em contato conosco pelo WhatsApp, e-mail ou telefone informando o motivo da troca.</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                <h3 className="text-lg font-semibold text-primary-600 mb-2">2. Envie o Produto</h3>
                <p className="text-sage-800 text-sm">Após a aprovação, envie o produto para nosso endereço com a etiqueta de retorno.</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                <h3 className="text-lg font-semibold text-primary-600 mb-2">3. Receba o Novo</h3>
                <p className="text-sage-800 text-sm">Após recebermos e analisarmos o produto, enviaremos o novo item ou reembolso.</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                <h3 className="text-lg font-semibold text-primary-600 mb-2">4. Acompanhe</h3>
                <p className="text-sage-800 text-sm">Acompanhe o status da sua troca pelo site ou entre em contato conosco.</p>
              </motion.div>
            </div>
          </motion.div>
          <motion.div 
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <FaClock className="text-primary-600" size={24} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="bg-primary-500/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                  <FaTruck className="text-primary-600" size={24} />
                </div>
              ...
              >
                <div className="bg-primary-500/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                  <FaCheckCircle className="text-primary-600" size={24} />
                </div>
                <h3 className="text-lg font-semibold text-sage-900 mb-2">100% Seguro</h3>
                <p className="text-sage-800 text-sm">Processo totalmente seguro e rastreado</p>
              </motion.div>
            </div>
          </motion.div>
          <motion.div 
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <FaExchangeAlt className="text-primary-600" size={24} />
              <h2 className="text-xl font-semibold text-sage-900">Casos Especiais</h2>
            </div>
            <div className="space-y-4">
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.5 }}
              >
                <h3 className="text-lg font-semibold text-primary-600 mb-2">Produto com Defeito</h3>
                <p className="text-sage-800">Em caso de defeito de fabricação, oferecemos troca imediata ou reembolso integral, independente do prazo de 30 dias.</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.6 }}
              >
                <h3 className="text-lg font-semibold text-primary-600 mb-2">Erro no Pedido</h3>
                <p className="text-sage-800">Se você recebeu um produto diferente do solicitado, entre em contato imediatamente para correção sem custos adicionais.</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <h3 className="text-lg font-semibold text-primary-600 mb-2">Reembolso</h3>
                <p className="text-sage-800">O reembolso será processado no mesmo método de pagamento utilizado na compra, em até 7 dias úteis após a aprovação.</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
