      ...
      <div className="w-full max-w-md bg-primary-50 rounded-3xl shadow-xl p-8 flex flex-col gap-8">
        ...
        <AnimatePresence>
          {showVerifyEmailModal && (
            ...
            >
              <motion.div
                className="bg-white border border-cloud-100 rounded-2xl shadow-2xl p-8 max-w-md w-full text-center relative"
              ...
              >
                <button
                  className="absolute top-4 right-4 text-sage-600 hover:text-primary-600 transition-colors"
                  onClick={() => setShowVerifyEmailModal(false)}
                  aria-label="Fechar"
                >
                  <X size={24} />
                </button>
                <EnvelopeSimple size={48} className="mx-auto mb-4 text-primary-600" />
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <label htmlFor="name" className="text-sage-900 font-semibold">Nome *</label>
            <input
              id="name"
              name="name"
              type="text"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="email" className="text-sage-900 font-semibold">E-mail *</label>
            <input
              id="email"
              name="email"
              type="email"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="phone" className="text-sage-900 font-semibold">Telefone</label>
            <input
              id="phone"
              name="phone"
              type="tel"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="password" className="text-sage-900 font-semibold">Senha *</label>
            ...
            {formData.password && (
              <div className="mt-2">
                ...
                <div className="text-xs text-sage-700 space-y-1">
                  ...
                  <div className={`flex items-center gap-2 ${/\d/.test(formData.password) ? 'text-green-600' : 'text-sage-500'}`}>
                    <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    Um número
                  </div>
                  <div className={`flex items-center gap-2 ${/[!@#$%^&*(),.?":{}|<>]/.test(formData.password) ? 'text-green-600' : 'text-sage-500'}`}>
                    <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="confirmPassword" className="text-sage-900 font-semibold">Confirmar Senha *</label>
            <div className="relative">
              <input
                id="confirmPassword"
          ...
          <div className="flex items-center justify-between mt-2">
            <Link href="/login" className="text-primary-600 text-sm hover:underline">Já tenho uma conta!</Link>
            <Link href="/" className="text-sage-700 text-sm hover:text-primary-600 hover:underline">Voltar</Link>
          </div>
          <motion.button
            type="submit"
